    ...
    public partial class InitialCreate : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_PostsMarks", x => new { x.UserId, x.PostId });
                    table.ForeignKey(
                        name: "FK_PostsMarks_AspNetUsers_UserId1",
                        column: x => x.UserId1,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_PostsMarks_UserPosts_PostId",
                        column: x => x.PostId,
                        principalTable: "UserPosts",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_CommentsMarks", x => new { x.UserId, x.CommentId });
                    table.ForeignKey(
                        name: "FK_CommentsMarks_AspNetUsers_UserId1",
                        column: x => x.UserId1,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_CommentsMarks_Comments_CommentId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CommentsMarks_CommentId",
                table: "CommentsMarks",
                column: "CommentId");

            migrationBuilder.CreateIndex(
                name: "IX_CommentsMarks_UserId1",
                table: "CommentsMarks",
                column: "UserId1");

            migrationBuilder.CreateIndex(
                name: "IX_PostsMarks_PostId",
                table: "PostsMarks",
                column: "PostId");

            migrationBuilder.CreateIndex(
                name: "IX_PostsMarks_UserId1",
                table: "PostsMarks",
                column: "UserId1");
